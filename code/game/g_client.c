...
*/
	...
	*/
	...
	Q_strncpyz(c1, Info_ValueForKey( userinfo, "color1" ), sizeof(c1)); // fix ioq3 - Cowcat
	Q_strncpyz(c2, Info_ValueForKey( userinfo, "color2" ), sizeof(c2)); // fix ioq3 - Cowcat

	//strcpy(redTeam, Info_ValueForKey( userinfo, "g_redteam" ));
	//strcpy(blueTeam, Info_ValueForKey( userinfo, "g_blueteam" ));
	Q_strncpyz(redTeam, Info_ValueForKey( userinfo, "g_redteam" ), sizeof(redTeam)); // fix ioq3 - Cowcat
	Q_strncpyz(blueTeam, Info_ValueForKey( userinfo, "g_blueteam" ), sizeof(blueTeam)); // fix ioq3 - Cowcat
